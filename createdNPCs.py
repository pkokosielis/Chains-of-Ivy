...
# Cornelia Blackwood, proprietor of Voss & Blackwood Furriers on the Mink Mile
sealskinCoat = Item("Sealskin Motoring Coat", "Suit", 2)
sealskinCoat.setItemValue(650)
ermineCloak = Item("Ermine-Lined Opera Cloak", "Suit", 7)
ermineCloak.setItemValue(1800)
silverFoxCoat = Item("Silver Fox Greatcoat", "Suit", 16)
silverFoxCoat.setItemValue(4200)
cornelia = StoreKeeper("Cornelia Blackwood", "Voss & Blackwood Furriers")
cornelia.setWelcomeMessage("The automaton at the door has already judged your coat, I'm afraid. Let's remedy that. I am Cornelia Blackwood.")
cornelia.setThanksMessage("Wear it forward into the cold, and forget you were ever without it.")
cornelia.addItem([sealskinCoat,ermineCloak,silverFoxCoat])

# Dr. Osric Penhallow, physician at the Ivy Cross Dispensary
willowBarkDraught = Item("Willow-Bark Draught", "Tonic", 10)
willowBarkDraught.setItemValue(150)
chorleyTincture = Item("Chorley Reserve Tincture", "Tonic", 25)
chorleyTincture.setItemValue(600)
sistersElixir = Item("The Sister's Elixir", "Tonic", 50)
sistersElixir.setItemValue(2200)
osric = StoreKeeper("Dr. Osric Penhallow", "The Ivy Cross Dispensary")
osric.setWelcomeMessage("Sit. Breathe. Whatever did that to you, it needn't finish the job. I am Dr. Penhallow.")
osric.setThanksMessage("Rest tonight if you can manage it. Come back before it's urgent, not after.")
osric.addItem([willowBarkDraught,chorleyTincture,sistersElixir])

# Julien Faucher, maitre d' of the Alderney Room
oxtailConsomme = Item("Bowl of Oxtail Consomme", "Tonic", 5)
oxtailConsomme.setItemValue(40)
roastPheasant = Item("Roast Pheasant with Chestnuts", "Tonic", 12)
roastPheasant.setItemValue(175)
chefsTable = Item("The Chef's Table", "Tonic", 20)
chefsTable.setItemValue(500)
julien = StoreKeeper("Julien Faucher", "The Alderney Room")
julien.setWelcomeMessage("Good evening. The kitchen is unhurried tonight, which is the only way it does anything well. I am Julien.")
julien.setThanksMessage("Digest slowly. Toronto will still be ruined tomorrow.")
julien.addItem([oxtailConsomme,roastPheasant,chefsTable])

# Percival Sterling, proprietor of Sterling & Vane
turkishCigars = Item("Turkish Blend Cigars", "Scroll", 2)
turkishCigars.setItemValue(80)
attarOfRose = Item("Attar of Damask Rose", "Scroll", 4)
attarOfRose.setItemValue(300)
sterlingReserve = Item("The Sterling Reserve", "Scroll", 6)
sterlingReserve.setItemValue(900)
percival = StoreKeeper("Percival Sterling", "Sterling & Vane")
percival.setWelcomeMessage("Something for the nerves, or something for the nose? Either way, you've come to the right window.")
percival.setThanksMessage("Savour it. The good blends aren't making it through customs anymore.")
percival.addItem([turkishCigars,attarOfRose,sterlingReserve])

# Old Mr. Grieve, clockwork outfitter
brassGoggles = Item("Brass Optic Goggles", "Helmet", 5)
brassGoggles.setItemValue(400)
gearedBoots = Item("Geared Walking Boots", "Boots", 7)
gearedBoots.setItemValue(750)
voltaicMonocle = Item("The Voltaic Monocle", "Helmet", 10)
voltaicMonocle.setItemValue(2600)
grieve = StoreKeeper("Old Mr. Grieve", "Grieve & Sons, Clockwork Outfitters")
grieve.setWelcomeMessage("Stand still a moment. I fit machines to men here, and men are always moving.")
grieve.setThanksMessage("Mind the joints don't seize. Oil is cheaper than I am.")
grieve.addItem([brassGoggles,gearedBoots,voltaicMonocle])
